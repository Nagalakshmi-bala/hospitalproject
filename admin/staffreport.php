               ...
               <table class="table">
                  ...
                  <tbody>
                    <?php
                      ...
                      <td><img src="/dashtreme-master/uploads/<?php echo $fetch_qr['img'];?>" width="100" height="100" alt="Patient Image"></td>
                      <td><video width="150" height="100" controls>
                              <source src="/dashtreme-master/uploads/<?php echo $fetch_qr['video']; ?>" width="150" height="100"  type="video/mp4">
                          </video></td>
                      </tr>
                      <?php
                      }

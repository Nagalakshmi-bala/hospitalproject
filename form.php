...
<div class="clearfix"></div>
    ...
    <div class="row mt-3">
      <div class="col-lg-12">
         <div class="card">
           ...
           <hr>
           <h3 hidden> <?php echo htmlspecialchars($username); ?> </h3>
           <form id="patientForm" method="POST" enctype="multipart/form-data">
           <div class="form-group">
            <label for="pname">Patient Name</label>
            <input type="text" class="form-control" name="pname" id="pname" placeholder="Enter Your Name">
           </div>
           <div class="form-group">
            <label for="date">Date</label>
            <input type="date" class="form-control" name="date" id="date" placeholder="Enter Your Date">
           </div>
           <div class="form-group">
            <label for="narration">Narration</label>
            <input type="text" class="form-control" name="narration" id="narration" placeholder="Enter Your Narration">
           </div> 
           <div class="form-group">
           <label for="img">Select Image:</label>
        <input type="file" name="img" id="img" accept="img/*"><br><br>
  ...
  $(document).ready(function () {
    $('#patientForm').on('submit', function (e) {
      ...
      $.ajax({
        url: 'forminsert.php', // Adjust if needed
        type: 'POST',
        data: formData,

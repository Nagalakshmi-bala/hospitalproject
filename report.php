        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <h3 hidden> <?php echo htmlspecialchars($admin); ?> </h3>
               ...
               <center><form method="POST" action="">
                  ...
                  <?php
                    ...
                    $qr="SELECT * FROM patientname WHERE admin='$admin' order by date desc";
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                      $start_date = mysqli_real_escape_string($link, $_POST['start_date']);
                      $end_date = mysqli_real_escape_string($link, $_POST['end_date']);
                      $qr = "SELECT * FROM patientname WHERE admin='$admin' AND date BETWEEN '$start_date' AND '$end_date'";
                    }
                    ...
                    <tr>
                    <td><?php echo $i++; ?></td>
                    <td><?php echo $fetch_qr['date'];?></td>
                    <td><?php echo $fetch_qr['pname'];?></td>
                    <td><?php echo $fetch_qr['narration'];?></td>
                    <td><img src="./uploads/<?php echo $fetch_qr['img'];?>" width="100" height="100" alt="Patient Image"></td>
                    <td><video width="150" height="100" controls>
                            <source src="./uploads/<?php echo $fetch_qr['video']; ?>" width="150" height="100"  type="video/mp4">
                        </video></td>
                    </tr>
                    <?php
                    }
